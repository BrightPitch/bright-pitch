    ...
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <div className="relative">
        ...
        <div className="absolute top-2 left-4 text-white">
          ...
          <div className="flex gap-2 mt-2">
            <span className="bg-gray-200 text-black text-xs px-2 py-1 rounded-full"># Food and beverage</span>
            <span className="bg-gray-200 text-black text-xs px-2 py-1 rounded-full"># Ongoing</span>
          </div>
        </div>
      ...
      <section className="p-4">
        <div className="flex items-center justify-between mb-2">
          ...
          <FaRegEdit className="text-purple-700 text-xl" />
        </div>
        <p className="text-sm text-gray-700 mb-2">
          Bagian ini berisi latar belakang permasalahan dari ide bisnis yang
        ...
        <ol className="list-decimal list-inside text-blue-600 text-sm space-y-1">
          <li>
            <a
              href="https://www.figma.com/design/1xm9vg8kU4vouevps5Hbnk/Startup_BrightPitch?node-id=7-193&t=BpKy2taJp0I0MQSu-0"
              target="_blank"
